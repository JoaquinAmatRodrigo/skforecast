...
<i class="fa-duotone fa-water" style="font-size: 25px;"></i> [**Multi-series-forecasting**](https://www.cienciadedatos.net/documentos/py44-multi-series-forecasting-skforecast.html)
