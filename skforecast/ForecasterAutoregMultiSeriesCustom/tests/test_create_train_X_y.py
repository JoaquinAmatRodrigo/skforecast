# Unit test _create_train_X_y ForecasterAutoregMultiSeriesCustom
# ==============================================================================
import re
import pytest
import numpy as np
...
def test_create_train_X_y_output_when_transformer_series_and_transformer_exog_with_different_series_lengths(transformer_series):
    ...
    expected = (
        pd.DataFrame(
            ...
            columns = ['custom_predictor_0', 'custom_predictor_1', 'custom_predictor_2', 
                       'l1', 'l2', 'l3', 'exog_1','exog_2_a', 'exog_2_b']
...
def test_create_train_X_y_output_series_dict_and_exog_dict_ordinal_encoding(
    ...
    expected = (
        ...
        .astype(
            {
                "custom_predictor_0": float,
                "custom_predictor_1": float,
                "custom_predictor_2": float,
                "_level_skforecast": int,
                "exog_1": float,
                "exog_2": object,
            }
