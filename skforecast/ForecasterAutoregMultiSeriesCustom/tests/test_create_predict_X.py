# Unit test create_predict_X ForecasterAutoregMultiSeriesCustom
# ==============================================================================
import re
import pytest
import joblib
    ...
    expected = {
        '1': pd.DataFrame(
                 ...
                 columns = ['custom_predictor_0', 'custom_predictor_1', 'custom_predictor_2',
                            'custom_predictor_3', 'custom_predictor_4', '1', '2'],
                 index = pd.RangeIndex(start=50, stop=55, step=1)
             )
    }
        ...
        '1': pd.DataFrame(
                 data = np.array([
                     ...
                     [ 0.57391142,  0.52579563,  0.44478046,  0.53267333,  0.47762884,
                       0.        , -0.77240468,  1.        ,  0.        ]]),
                 columns = ['custom_predictor_0', 'custom_predictor_1', 'custom_predictor_2',
                            'custom_predictor_3', 'custom_predictor_4', '_level_skforecast', 
