...
@pytest.mark.parametrize("forecaster_name, regressor_name, refit, n_jobs_expected", 
                         [('ForecasterAutoreg', 'LinearRegression', True, 1),
                          ...
                          ('ForecasterAutoreg', 'HistGradientBoostingRegressor', True, cpu_count()),
                          ('ForecasterAutoreg', 'HistGradientBoostingRegressor', 2, 1),
                          ('ForecasterAutoreg', 'HistGradientBoostingRegressor', False, 1),
                          ...
                          ('ForecasterAutoregDirect', 'HistGradientBoostingRegressor', True, 1),
                          ('ForecasterAutoregDirect', 'HistGradientBoostingRegressor', 2, 1),
                          ('ForecasterAutoregDirect', 'HistGradientBoostingRegressor', False, 1),
                          ...
                          ('ForecasterAutoregMultiseries', 'HistGradientBoostingRegressor', True, cpu_count()),
                          ('ForecasterAutoregMultiseries', 'HistGradientBoostingRegressor', 2, 1),
                          ('ForecasterAutoregMultiseries', 'HistGradientBoostingRegressor', False, cpu_count()),
