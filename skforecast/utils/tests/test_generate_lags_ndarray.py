# Unit test generate_lags_ndarray
# ==============================================================================
import re
import pytest
import numpy as np
import pandas as pd
from skforecast.utils import generate_lags_ndarray
...
def test_init_exception_when_lags_is_not_valid_type_ForecasterAutoregMultiVariate():
    """
