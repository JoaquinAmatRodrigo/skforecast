...
def test_exog_to_direct_when_lags_3_steps_2_exog_numpy_1d():
    """
    Test exog_to_direct results when using lags 3, steps 2 and exog is a  
    1d numpy array.
    """
    exog = np.arange(10)
...
def test_exog_to_direct_when_lags_3_steps_2_exog_numpy_array_2d():
    """
    Test exog_to_direct results when using lags 3, steps 2 and exog is a  
    2d numpy array.
    """
...
def test_exog_to_direct_when_lags_2_steps_3_exog_numpy_array_2d():
    """
    Test exog_to_direct results when using lags 2, steps 3 and exog is a  
    2d numpy array.
    """
    exog = np.column_stack([np.arange(100, 110), np.arange(1000, 1010)])
