...
def test_check_select_fit_kwargs_warning_when_fit_kwargs_has_arguments_not_in_fit():
    """
    Test check_select_fit_kwargs issues warning when fit_kwargs has arguments 
    not in regressor fit method.
    """
...
def test_check_select_fit_kwargs_UserWarning_when_fit_kwargs_has_sample_weight():
    """
    Test check_select_fit_kwargs issues UserWarning when fit_kwargs has 
